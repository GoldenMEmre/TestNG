...
public class C04_DataProviderNegatifLoginTest {
    ...
    @DataProvider
    public static Object[][] YanlisKullaniciAdlariListesi() {//METHOD OLUŞTURULDU
    ...
    @Test(dataProvider = "YanlisKullaniciAdlariListesi")//Böyle yazınca yukarıda bir method oluşturmayı teklif ediyor.
